...
const siteUrl = 'https://trinitetech.com'
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: ['/assets/favicon_io_trinity/android-chrome-512x512.png'],
    type: 'website',
  },
  twitter: {
  ...
  verification: {
    google: ['SQOh55Ri1bMC2hsTB05o2ZZs-T_CW_oiyBDRId16aKg', 'aeIxfmPDMSsEoi8lI_jC-CblZM22vKCRyaTVEebF8LQ'],
  },
    ...
    <html lang="en" data-scroll-behavior="smooth">
      <head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({
          ...
          "logo": "https://trinitetech.com/assets/images/trinity-logo.webp",
